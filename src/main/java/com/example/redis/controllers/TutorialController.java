...
import com.example.redis.services.tutorial.TutorialService;
...
public class TutorialController {
    ...
    public ResponseEntity<Tutorial> updateTutorial(@PathVariable("id") long id, @RequestBody Tutorial tutorial) {
        ...
        if (tutorialData.isPresent()) {
            Tutorial tutorialResponse = tutorialData.get();
            tutorialResponse.setTitle(tutorial.getTitle());
            tutorialResponse.setDescription(tutorial.getDescription());
            tutorialResponse.setPublished(tutorial.isPublished());
            return new ResponseEntity<>(tutorialService.update(tutorialResponse), HttpStatus.OK);
        } else {
